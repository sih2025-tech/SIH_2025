...
def fetch_msamb_by_crop(crop_mr, output_csv="msamb_selected_crop.csv"):
    ...
    print(f"Market data for crop '{crop_mr}' saved to {output_csv}")
    driver.quit()
    return output_csv

def get_rates_for_city(csv_file, city_en):
...
def main():
    ...
    if not crop_mr:
        ...
        return
    csv_file = fetch_msamb_by_crop(crop_mr)
    get_rates_for_city(csv_file, city_en)
